...
import { formatCurrency, formatDate, translateContractStatus } from "@/lib/formatters";
              ...
              return (
                <tr key={c.id} className="hover:bg-[#F8F7F4] transition-colors">
                  ...
                  <td className="px-5 py-3.5 font-medium text-[#252724]">
                    {c.primaryTenantName}
                    <div className="text-[11px] text-[#73766F] font-normal">Tổng {c.tenantsCount} thành viên</div>
                  </td>
