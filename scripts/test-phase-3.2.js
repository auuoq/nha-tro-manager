...
const room_schema_1 = require("../src/features/rooms/schemas/room.schema");
const room_charge_config_schema_1 = require("../src/features/rooms/schemas/room-charge-config.schema");
...
async function runPhase32Tests() {
    ...
    try {
        const res = room_schema_1.createRoomSchema.safeParse({
    ...
    try {
        const res = room_charge_config_schema_1.roomChargeConfigSchema.safeParse({
